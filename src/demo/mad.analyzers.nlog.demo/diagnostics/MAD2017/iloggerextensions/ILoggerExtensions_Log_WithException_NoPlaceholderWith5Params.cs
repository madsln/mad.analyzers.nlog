...
public class ILoggerExtensions_Log_WithException_NoPlaceholderWith5Params
{
    ...
    public void ShouldRaiseDiagnostic_MAD2017()
    {
        ...
        _logger.ConditionalTrace(exception, CultureInfo.InvariantCulture, "Message without placeholder", intArg, boolArg, stringArg, doubleArg, objectArg);
    }
}
