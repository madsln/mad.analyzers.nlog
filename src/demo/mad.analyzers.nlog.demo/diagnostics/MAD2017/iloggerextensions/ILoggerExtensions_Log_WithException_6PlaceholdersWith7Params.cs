...
public class ILoggerExtensions_Log_WithException_6PlaceholdersWith7Params
{
    ...
    public void ShouldRaiseDiagnostic_MAD2017()
    {
        ...
        _logger.ConditionalTrace(exception, CultureInfo.InvariantCulture, "Message with {Placeholder1}{Placeholder2}{Placeholder3}{Placeholder4}{Placeholder5}{Placeholder6}", intArg, boolArg, stringArg, doubleArg, objectArg, decimalArg, longArg);
    }
}
