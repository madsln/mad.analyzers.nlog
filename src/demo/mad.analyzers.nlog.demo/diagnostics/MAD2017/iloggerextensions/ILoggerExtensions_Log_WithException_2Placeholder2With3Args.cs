...
public class ILoggerExtensions_Log_WithException_2Placeholder2With3Args
{
    ...
    public void ShouldRaiseDiagnostic_MAD2017()
    {
        ...
        var boolArg = true;
        var stringArg = "foo";
        _logger.ConditionalTrace(exception, CultureInfo.InvariantCulture, "Message with {Placeholder1}{Placeholder2}", intArg, boolArg, stringArg);
    }
}
