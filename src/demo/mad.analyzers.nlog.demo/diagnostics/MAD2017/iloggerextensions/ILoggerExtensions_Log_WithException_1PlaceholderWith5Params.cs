...
public class ILoggerExtensions_Log_WithException_1PlaceholderWith5Params
{
    ...
    public void ShouldRaiseDiagnostic_MAD2017()
    {
        ...
        _logger.ConditionalTrace(exception, CultureInfo.InvariantCulture, "Message with {Placeholder1}", intArg, boolArg, stringArg, doubleArg, objectArg);
    }
}
