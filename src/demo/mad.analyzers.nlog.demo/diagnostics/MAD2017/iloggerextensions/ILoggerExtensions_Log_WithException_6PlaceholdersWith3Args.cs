...
public class ILoggerExtensions_Log_WithException_6PlaceholdersWith3Args
{
    ...
    public void ShouldRaiseDiagnostic_MAD2017()
    {
        ...
        var boolArg = true;
        var stringArg = "foo";
        _logger.ConditionalTrace(exception, CultureInfo.InvariantCulture, "Message with {Placeholder1}{Placeholder2}{Placeholder3}{Placeholder4}{Placeholder5}{Placeholder6}", intArg, boolArg, stringArg);
    }
}
