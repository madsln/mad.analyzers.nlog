...
public class ILoggerExtensions_Log_WithException_3PlaceholdersWith4Args
{
    ...
    public void ShouldRaiseDiagnostic_MAD2017()
    {
        ...
        var stringArg = "foo";
        var doubleArg = 3.14;
        _logger.ConditionalTrace(exception, CultureInfo.InvariantCulture, "Message with {Placeholder1}{Placeholder2}{Placeholder3}", intArg, boolArg, stringArg, doubleArg);
    }
}
