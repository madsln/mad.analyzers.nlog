...
[TestClass]
public class diagnostics_MAD2255_ilogger_Tests
{
    [TestMethod]
    [DataRow("Trace")]
    [DataRow("Debug")]
    ...
    [DataRow("Error")]
    [DataRow("Fatal")]
    public async Task ILogger_Log_ExceptionMessagePassedAsArgument_ShouldRaiseDiagnostic_MAD2255(string logLevel)
    {
        var template = @"
        using System;
        using NLog;
    ...
    [DataRow("Error")]
    [DataRow("Fatal")]
    public async Task ILogger_Log_ExceptionPassedAsArgument_ShouldRaiseDiagnostic_MAD2255(string logLevel)
    {
        var template = @"
        using System;
        using NLog;
    ...
    [DataRow("Error")]
    [DataRow("Fatal")]
    public async Task ILogger_Log_ExceptionToStringPassedAsArgument_ShouldRaiseDiagnostic_MAD2255(string logLevel)
    {
        var template = @"
        using System;
        using NLog;
    ...
    [DataRow("Error")]
    [DataRow("Fatal")]
    public async Task ILogger_Log_ParamCountMismatchExceptionPassedAsParam_ShouldRaiseDiagnostic_MAD2255(string logLevel)
    {
        var template = @"
        using System;
        using NLog;
