...
namespace mad.analyzers.common
{
    ...
    public class WellKnownTypeProvider
    {
        ...
        private ConcurrentDictionary<string, ImmutableArray<INamedTypeSymbol>>? _getTypesCache;
        ...
        internal ImmutableArray<INamedTypeSymbol> GetTypesByMetadataName(string fullyQualifiedMetadataName)
        {
            var getTypesCache = LazyInitializer.EnsureInitialized(
                ref _getTypesCache, static () => new ConcurrentDictionary<string, ImmutableArray<INamedTypeSymbol>>(ReferenceEqualityComparer.Instance))!;
            ...
            ImmutableArray<INamedTypeSymbol> getTypesByMetadataNameImpl()
            {
                ...
                return typesByMetadataName?.ToImmutableArray() ?? ImmutableArray<INamedTypeSymbol>.Empty;
        ...
        {
            List<string> namespaceNamesBuilder = new List<string>();
            ...
            return namespaceNamesBuilder.ToImmutableArray();
        }
